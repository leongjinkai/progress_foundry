...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF0266FF);
  late Color secondary = const Color(0xFF5E5E5E);
  late Color tertiary = const Color(0xFFFAFAFA);
  late Color alternate = const Color(0xFFACCDFF);
  ...
  late Color accent4 = const Color(0xFFE0ECFF);
