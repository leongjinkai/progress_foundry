...
class NewAssignmentStruct extends BaseStruct {
  NewAssignmentStruct({
    String? id,
  ...
  static NewAssignmentStruct fromMap(Map<String, dynamic> data) =>
      NewAssignmentStruct(
  ...
  static NewAssignmentStruct? maybeFromMap(dynamic data) => data is Map
      ? NewAssignmentStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static NewAssignmentStruct fromSerializableMap(Map<String, dynamic> data) =>
      NewAssignmentStruct(
        id: deserializeParam(
          data['id'],
          ParamType.String,
  ...
  @override
  String toString() => 'NewAssignmentStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is NewAssignmentStruct &&
        id == other.id &&
...
NewAssignmentStruct createNewAssignmentStruct({
  String? id,
  String? assignmentName,
  String? studentId,
  String? createdAt,
